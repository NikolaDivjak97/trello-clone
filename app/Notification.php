...
class Notification extends Model
{
    ...
    // FUNCTIONS
    public static function notifyAll($owner, $model, $users, $event)
    {
                ...
                case Card::class:
                    ...
                    switch ($event) {
                        ...
                        case 'new_images':
                            ...
                            break;
                        case 'update_comment_added':
                            //                            $notification->link = route('boards.show', $model->board->id) . '?card=' . $model -> id;
                            //                            $notification->message = 'User ' . $owner->name . ' has moved card ' . $model->name . ' to List ' . $model -> phase -> name;
                            //                            $notification->save();
